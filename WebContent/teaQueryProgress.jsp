...
<body>
								...
								<tbody>
									...
									if (roleSession != null && roleSession.toString().equals("yes")) {
										...
										if (group == null) {
											...
											list = ReportDao.selectReports(sql, para);
										} else {
											String sql = "SELECT * FROM testdb.reports WHERE groupname=? ORDER BY timestamp DESC";
											String[] para = new String[]{group};
											list = ReportDao.selectReports(sql, para);
										}
									}
	...
	<script type="text/javascript">
		...
		document.getElementById('hiddenRequestURL').value = "teaQueryProgress.jsp";
	</script>
</body>
</html>
